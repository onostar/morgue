        ...
        <section class="addUserForm">
            ...
            <div class="inputs">
                ...
                <div class="data">
                    ...
                    <input type="number" name="age" id="age" placeholder="35" required>
                </div>
            </div>
            <div class="inputs">
                <div class="data">
                ...
                <div class="data">
                    ...
                    <input type="text" name="contact_person" id="contact_person" placeholder="James Akanuche" required>
                </div>
                <div class="data">
            ...
            <div class="inputs">
                ...
                <div class="data">
                    ...
                    <select name="death_cause" id="death_cause" required>
                        <option value=""select>Select Death cause</option>
