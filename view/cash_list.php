...
<div class="displays allResults new_data" id="revenue_report">
    ...
    <table id="payment_mode_table" class="searchTable">
        <thead>
        ...
        <tbody>
            <?php
                ...
                $details = $get_users->fetch_details_curdateCon('payments', 'post_date', 'payment_mode', 'Cash');
    ...
    <?php
        ...
        $amounts = $get_total->fetch_sum_curdateCon('payments', 'amount_paid', 'post_date', 'payment_mode', 'Cash');
