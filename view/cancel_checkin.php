    ...
    <table id="check_out_table" class="searchTable">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><a href="javascript:void(0)" title="View guest details" onclick="showPage(12, 'guest_details.php?guest_id=<?php echo $detail->guest_id?>')"><?php echo $detail->last_name . " ". $detail->first_name;?></a></td>
                <td>
                    <?php 
                        $get_cat = new selects();
